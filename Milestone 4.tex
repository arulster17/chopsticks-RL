...
\title{
    \textbf{Milestone 4 Final Report} \\
...
\begin{figure}[h!]
    ...
    \caption{Episode length over training for $\alpha=1 \times 10^{-2}$}
    \label{fig:episode}
\end{figure}
...
\begin{figure}[h!]
    ...
    \caption{Q-learning convergence for $\alpha=1 \times 10^{-2}$ (default)}
    \label{fig:qconv}
\end{figure}
